...
| Area | Read when |
|---|---|
| `map-repo.md` | You need the current root layout |
| `GOVERNMENT/User-Constitution/project-definition.md` | You need the detailed project definition or corpus boundaries |
...
- Changes to `GOVERNMENT/User-Constitution/` and `GOVERNMENT/Court-Precedents/` need explicit user approval or a staged proposal.
- Current approval covers the initial GOVERNMENT bootstrap and T0 corpus boundary recorded on 2026-06-10.
