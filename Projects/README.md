...
| Path | Role |
|---|---|
| `1D-multi-solver-demo/` | Active 1D solver-seam and theory-first project |
| `Cluster_Ising/` | Runnable Cluster-Ising paper reproduction and solver benchmark project |
